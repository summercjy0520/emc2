...
% [TXT,NUMERIC,RAW] = xlsread('C:\Documents and Settings\Administrator\×ÀÃæ\cjy\2017\7\data\Sales_Weekly.csv');

TXT= importdata('C:\Documents and Settings\Administrator\×ÀÃæ\cjy\2017\7\data\Trace_TRAIN');
TXT1= importdata('C:\Documents and Settings\Administrator\×ÀÃæ\cjy\2017\7\data\Trace_TEST');
% S=TXT(:,1:end-1);
% S=TXT.data;
% TXT=cell2mat(TXT);
